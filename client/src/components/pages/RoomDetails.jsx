...
const RoomDetails = () => {
  ...
  return  room && (
    <div className='py-28 md:py-35 px-4 md:px-16 lg:px-24 xl:px-32'>
        ...
        {/*Room Images*/}
        <div className='flex flec-col lg:flex-row mt-6 gap-6'>
            ...
            <div className='grid grid-cols-2 gap-4 lg:w-1/2 w-full'>
                {room?.images.length > 1 && room.images.map((image, index)=>(
                    <img onClick={()=> setMianImage(image)}
        ...
        mx-auto mt-16 max-w6xl'>
            ...
            md:items-center gap-4 md:gap-10 text-gray-500'>
                ...
                <div className='flex flex-col'>
                    ...
                    <input type="date" id='checkInDate' placeholder='Check_In' 
                ...
                <div className='flex flex-col'>
                    ...
                    <input type="date" id='checkOutDate' placeholder='Check_Out' 
                    className='w-full rounded border border-gray-300 px-3 py-2 mt-1.5 outline-none' required/>
                </div>
