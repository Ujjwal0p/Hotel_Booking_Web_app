...
const FeaturedDestination = () => {
  ...
  return (
    <div className='flex flex-col items-center px-6  md:px-16 lg:px-24 bg-slate-50 py-20'>
        ...
        properties around the world, offering unparalleled luxury and unforgettable experirnces.'/>
        ...
        className='my-16 px-4 p-2 text-sm font-medium border border-gray-300
