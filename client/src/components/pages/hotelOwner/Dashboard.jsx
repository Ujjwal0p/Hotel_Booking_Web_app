...
const Dashboard = () => {
  ...
  return (
    <div>
      ...
      track booking and analyze revenue-all in one place. Stay updated with real-time insights to
                ...
                <tr key={index}>
                  ...
                  <td className='py-3 px-4 border-t border-gray-300 flex'>
                    <button className={`py-1 px-3 text-xs rounded-full mx-auto 
                      ${item.isPaid ? 'bd-green-200 text-green-600' : 'bg-amber-200 text-yellow-600'}`}>
